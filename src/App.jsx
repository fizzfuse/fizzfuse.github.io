...
const SHEETS_ENDPOINT = 'https://script.google.com/macros/s/AKfycbyWK2a17oW8siozgT5IC3R9_tWKZAmyPEGx-JDxxTZv4N2lxS0aZlhR3LJw3QyTqqsZDQ/exec';
...
const BirthdayApp = () => (
  <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white p-4 md:p-8">
    <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_center,rgba(34,211,238,0.05),transparent)] pointer-events-none" />
    ...
    <div className="container mx-auto max-w-4xl">
      ...
      <div className="space-y-12">
        <section>
          <h2 className="text-2xl md:text-3xl font-semibold mb-6 flex items-center justify-center gap-2 text-cyan-400">
